      ...
      >
            ...
            sessions.length > 0 ? (
              sessions.map((s) => (
                <button
                  ...
                  className="w-full text-left px-4 py-2 rounded-md hover:bg-[#1a1a1a] text-sm transition-colors truncate"
                >
                  {s.title}
                </button>
              ))
        ...
        <div className="p-4 border-t border-white/10">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 text-sm px-3 py-2 bg-orange-500 text-black rounded-md hover:bg-orange-600"
          >
