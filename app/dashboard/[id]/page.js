        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() =>
              updateOnboarding({
                id,
                tone: prompt("Enter new tone:", campaign.tone) || campaign.tone,
              })
            }
            className="flex items-center gap-1 text-xs px-3 py-1 rounded-md bg-black/10 hover:bg-black/20 transition-all"
          >
            <Pencil size={14} />
            Edit
          </button>
          <button
            ...
            className="flex items-center gap-1 text-xs px-3 py-1 rounded-md bg-black/10 hover:bg-black/20 transition-all text-red-700"
          >
            <Trash2 size={14} />
            Delete
          </button>
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-black rounded-lg font-medium hover:opacity-90"
              >
                Yes, delete
              </button>
              <button
                onClick={() => setConfirmDelete(false)}
                className="px-4 py-2 bg-[#222] text-gray-300 rounded-lg border border-[#333] hover:bg-[#333]"
              >
                Cancel
              </button>
            </div>
        ...
        <div className="w-full max-w-2xl flex flex-col bg-[#141414] rounded-2xl border border-[#1f1f1f] shadow-lg overflow-hidden">
          <div className="p-6 border-b border-[#1f1f1f] flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 text-black font-medium hover:opacity-90 transition-all"
            >
              ...
              sessions.length > 0 ? (
                sessions.map((s) => (
                  <button
                    ...
                    className="w-full text-left px-4 py-3 rounded-md bg-[#1b1b1b] hover:bg-[#1f1f1f] border border-[#2a2a2a] text-sm text-gray-300 hover:border-orange-500/50 transition-all"
                  >
